 ...
 * <div><div>Related Topics</div><div><li>哈希表</li><li>链表</li><li>双指针</li></div></div><br><div><li>👍 1285</li><li>👎 0</li></div>
 */
...
public class LinkedListCycle141 {
    public static void main(String[] args) {
        ...
        ListNode input = new ListNode(new int[]{1, 2});
        long startTime = System.currentTimeMillis();
        boolean res = solution.hasCycle(input);
    ...
    public class Solution {
        public boolean hasCycle(ListNode head) {
            ListNode fast, slow;
            fast = slow = head;
            //这里的fast相当于是一路遍历过去的，它所经过的地方肯定不会有null，所以不需要检测slow
